...
from data_access import load_all_cards, make_content_text
...
# ===== 2) 텍스트 합치기 =====
texts = [make_content_text(c) for c in contents]
...
# ===== 4) FAISS 인덱스 생성 =====
index = faiss.IndexFlatIP(emb.shape[1])  # normalize_embeddings=True면 코사인 내적
index.add(emb)
