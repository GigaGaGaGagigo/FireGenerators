...
from ui.analysis.auto_trade_feedback import auto_trade_feedback
...
# 세션 user_id
#FIXED_USER_ID = st.session_state.user.id

FIXED_USER_ID = ""

if FIXED_USER_ID == "":
    FIXED_USER_ID = "5eb9789f-bd00-4b3c-8149-bf4652af8540"
